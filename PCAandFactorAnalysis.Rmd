...
knitr::include_graphics("https://vieiradata.s3.us-east-2.amazonaws.com/Figures/Factor+Analysis.PNG")
```
...
```{r, out.width = "400px", fig.align="center"}
knitr::include_graphics("https://vieiradata.s3.us-east-2.amazonaws.com/Figures/PCA.PNG")
```
...
```{r, out.width = "400px", fig.align="center"}
knitr::include_graphics("https://commons.wikimedia.org/wiki/File:Screeplotr.png")
```
...
```{r, out.width = "400px", fig.align="center"}
knitr::include_graphics("https://vieiradata.s3.us-east-2.amazonaws.com/Figures/resultsFactorAnalysis.PNG")
```
